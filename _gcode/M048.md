...
examples:
  -
    pre: A simple example to test the accuracy of your probe using an host software.
    code:
      - M48 P10 V2  ; probe 10 time and show the information while probing in your host software
